...
* Ubuntu Linux 24.04, 22.04 (x64 architecture)
...
Operating systems, distributions, versions, and architectures other than those listed above are not officially supported.
Please also note that we cannot guarantee operation on virtual machines.
